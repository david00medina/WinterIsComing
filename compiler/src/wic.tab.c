...
static const char *const yytname[] =
{
  ...
  "VOID", "FUN", "INT_VAL", "REAL_VAL", "BOOL_VAL", "CHAR_VAL",
  "STRING_VAL", "INT_TYPE", "REAL_TYPE", "BOOL_TYPE", "CHAR_TYPE",
  ...
  "AND_BIT", "OR_BIT", "XOR_BIT", "LEFT_SHIFT", "RIGHT_SHIFT", "IF_CLAUSE",
  "FOR_WHILE_CLAUSE", "HEADER_END", "ELSE_IF_FOR_WHILE_CLAUSE",
  "ARRAY_OPEN", "ARRAY_CLOSE", "ARRAY_ELEM_OPEN", "ARRAY_ELEM_CLOSE",
  "ELEM_SEPARATOR", "FUN_PARAM_OPEN", "FUN_PARAM_CLOSE", "END_OF_INSTR",
  "BLANK_SPACE", "CONTEXT_TAG", "ID", "$accept", "input", YY_NULLPTR
};
#endif
...
#line 1276 "wic.tab.c" /* yacc.c:1652  */
      default: break;
    }
