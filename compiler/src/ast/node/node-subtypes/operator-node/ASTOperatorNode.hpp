...
namespace wic
{
    ...
    protected:
        ...
        cpu_registers int_to_float(cpu_registers, CodeGenerator*);
        cpu_registers float_to_int(cpu_registers, CodeGenerator*);
        cpu_registers operand_type_conversion(cpu_registers, cpu_registers, CodeGenerator*);
        ...
        cpu_registers operate(CodeGenerator*);
