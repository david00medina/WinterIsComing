...
\begin{document}
	...
	* 		-> 	PRODUCT
	...
	\subsection{Gramática para análisis sintáctico por descenso recursivo}
	...
	while_instr := 	expr FOR_WHILE_CLAUSE HEADER_END END_OF_INSTR OPEN_CONTEXT_TAG input CLOSE_CONTEXT_TAG
	...
	\includegraphics[scale=0.33]{../res/pics/diagramas/while_instr.jpg}
	\newline
	Diagrama sintáctico para while\_instr
	\newline
	\newline
	\newline
	\includegraphics[scale=0.5]{../res/pics/diagramas/input.jpg}
	\newline
	Diagrama sintáctico para input
	\newline
	\newline
	\newline
	\includegraphics[scale=0.5]{../res/pics/diagramas/instr.jpg}
	\newline
	Diagrama sintáctico para instr
	\newline
	\newpage
	\includegraphics[scale=0.4]{../res/pics/diagramas/expr.jpg}
	\newline
	Diagrama sintáctico para expr
	\newline
	\newline
	\newline
	\includegraphics[scale=0.4]{../res/pics/diagramas/term.jpg}
	\newline
	Diagrama sintáctico para term
	\newline
	\newline
	\newline
	\includegraphics[scale=0.4]{../res/pics/diagramas/data_value.jpg}
	\newline
	Diagrama sintáctico para data\_value
	\newline
	\newline
	\newline
	\includegraphics[scale=0.4]{../res/pics/diagramas/data_type.jpg}
	\newline
	Diagrama sintáctico para data\_type
	\newline
	\newpage
	\begin{table}[H]
		\begin{tabular}{l|l|l}
			\toprule
			\textbf{no\_terminal} & \textbf{primeros} & \textbf{siguientes}\\
			\midrule
			while\_instr & ID, INT\_VAL, REAL\_VAL, BOOL\_VAL & \$ \\
			input & ID, INT\_VAL, REAL\_VAL, BOOL\_VAL, empty & CLOSE\_CONTEXT\_TAG \\
			instr & ID, INT\_VAL, REAL\_VAL, BOOL\_VAL & ID \\
			& & INT\_VAL \\
			& & REAL\_VAL \\
			& & BOOL\_VAL \\
			& & CLOSE\_CONTEXT\_TAG \\
			expr & ID, INT\_VAL, REAL\_VAL, BOOL\_VAL & FOR\_WHILE\_CLAUSE \\
			term & ID, INT\_VAL, REAL\_VAL, BOOL\_VAL & LESS \\
			& & GREATER \\
			& & EQUALS \\
			& & ID \\
			& & INT\_VAL \\
			...
			& & BOOL\_VAL \\
			& & END\_OF\_INSTR \\
			data\_value & INT\_VAL, REAL\_VAL, BOOL\_VAL & LESS \\
			& & GREATER \\
			& & EQUALS \\
			& & ID \\
			& & INT\_VAL \\
			...
			& & PRODUCT \\
			& & DIVIDE \\
			data\_type & INT\_TYPE, REAL\_TYPE, BOOL\_TYPE & ID \\
			\bottomrule
		\end{tabular}
	\end{table}
	...
	\begin{table}[H]
		\begin{tabular}{l|l|l}
			\toprule
			\textbf{conjunto\_director} & \textbf{grupo} & \textbf{siguientes}\\
			\midrule
			d1 & 1 & ID, INT\_TYPE, REAL\_TYPE, BOOL\_TYPE \\
			d2 & 1 & CLOSE\_CONTEXT\_TAG \\
			d3 & 2 & INT\_TYPE, REAL\_TYPE, BOOL\_TYPE \\
			d4 & 2 & ID \\
			d5 & 3 & END\_OF\_INSTR \\
			d6 & 3 & ASSIGN \\
			d7 & 4 & LESS \\
			d8 & 4 & GREATER \\
			d9 & 4 & EQUALS \\
			d10 & 4 & FOR\_WHILE\_INSTR \\
			d11 & 5 & ID \\
			d12 & 5 & INT\_VAL, REAL\_VAL, BOOL\_VAL \\
			d13 & 6 & SUM \\
			d14 & 6 & SUBSTRACT \\
			d15 & 6 & PRODUCT \\
			d16 & 6 & DIVIDE \\
			d17 & 6 & LESS, GREATER, EQUALS, ID, INT\_VAL, REAL\_VAL \\
			& & BOOL\_VAL, END\_OF\_INSTR \\
			d18 & 7 & INT\_VAL \\
			d19 & 7 & REAL\_VAL \\
			d20 & 7 & BOOL\_VAL \\
			d21 & 8 & INT\_TYPE \\
