...
\begin{itemize}
	...
	\item \textbf{'return'} . Palabra empleada para retornar el resultado de un método o función, además de interrumpir la ejecución del mismo.\item \textbf{'fun'} . Palabra especial utilizada al principio de cada declaración o definición de funciones.
\end{itemize}
\newpage
